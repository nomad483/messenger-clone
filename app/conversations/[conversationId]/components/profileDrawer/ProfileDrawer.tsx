...
export const ProfileDrawer = ({ data, isOpen, onClose }: Props) => {
  const otherUser = useOtherUser(data)
  const [confirmOpen, toggleConfirmOpen] = useToggle()
  ...
  return (
    <>
      <ConfirmModal isOpen={confirmOpen} onClose={toggleConfirmOpen} />
